...
class LikeService extends WebService
{
    ...
    public function store(Request $request)
    {
        ...
        if($table_name == "posts"){
            $like = Post::get_post_by_id($reference_id);
        }
        else{
            $like = Comment::get_comment_by_id($reference_id);
        }
    ...
    public function delete(Request $request)
    {
        ...
        if($like != null){
            ...
            if($request->table_name == "posts"){
                $like = Post::get_post_by_id($request->reference_id);
            }
            else{
                $like = Comment::get_comment_by_id($request->reference_id);
            }
        }
        else{
            $like = "Not Found";
